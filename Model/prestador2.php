...
try {
  ...
  if ($user) {
    ...
    $caminho_imagem = "../Controller/uploads/" . $arquivo; // A pasta uploads está no mesmo nível do PHP
    $linktelefone = "";
  } else {
    echo "Usuário não encontrado.";
    exit; // Encerra o script para evitar exibição desnecessária
  }
...
<head>
  ...
  <link rel="stylesheet" href="../Controller/css/prestador1.css">
  <style>
    .imgfoto {
      width: 40vw;
      height: 50vh
...
<body style="font-family: Arial, Helvetica, sans-serif; margin: 0;">
  <div style="height: 20vh; background-color: #238E68; display: flex;  flex-direction: column;" class="incial">
    ...
    <div class="d1-f">
      <div>
        <div class="rd"><?php echo $nome; ?></div>
        <div class="he"><?php echo $area_atuacao; ?></div>
        <div class="he">Eletricista e encanador experiente.</div>
        <div class="d_emai"><?php echo $email; ?></div>
        <div class="d_emai"><?php echo $telefone; ?></div>
        <div><?php echo $sobre; ?> <br>
          <br>
        </div>
      ...
      <div class="divtudo">
        <div class="d-img">
          <img class="imgfoto" src="<?php echo $caminho_imagem; ?>" alt="">
        </div>
        <div class="icons">
          <div>
            <a href=""><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="4vh" height="4vh"
                viewBox="0 0 50 50">
                <path
