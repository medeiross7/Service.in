...
.indicador {
  ...
  transition: transform 0.5s; /* Suaviza a animação */
}
    ...
    <div class="rodape">
        <div>
            ...
            <p class="paragrafro">
                ...
                Para mais informações, visite nossa pagina <a style="color: white; font-size: 22px;" href="">SOBRE NÓS</a> ou entre em contato conosco.
            <p>
        </div>
        <divl> 
...
trilho.addEventListener('click', () => {
  ...
  indicador.style.transform = indicador.style.transform === 'translateX(50px)' ? 'translateX(0)' : 'translateX(50px)';
